...
import type { GroundControlPoint, CalibrationMode, AddToken } from '@/lib/db/schema'
...
// QR Code Generator Section for mobile hotspot creation
function QRCodeGeneratorSection({ projectId, accessCode }: { projectId?: number; accessCode?: string }) {
  ...
  return (
    <div className="bg-white rounded-lg border p-6 space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="font-semibold">Mobile Hotspot Creator</h3>
        <span className="text-xs bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 px-2 py-1 rounded-full font-medium">
          New
        </span>
      </div>
...
export default function PortalSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* QR Code Generator for Mobile Hotspot Creation */}
      <QRCodeGeneratorSection projectId={project?.id} accessCode={project?.accessCode} />
